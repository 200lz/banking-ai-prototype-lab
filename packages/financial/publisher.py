"""Developer-only typed Delta publisher, shared by local and installed-wheel entry points."""
...
def publish_bytes(raw_bytes: bytes, catalog: str, schema: str, spark: Any) -> dict[str, Any]:
    catalog, schema = identifier(catalog), identifier(schema)
    layers = build_layers(raw_bytes)
